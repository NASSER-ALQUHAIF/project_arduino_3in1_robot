...
void loop() {
  ...
  {
    bt = Serial2.read();  //read it to select mode1
  }
 switch (bt) {
    case 'X': mode1 = true; break;
    case 'V': mode2 = true; break;
    case 'x': mode1 = false; break;
    case 'v': mode2 = false; break;
  }
  ...
  if (mode1 == true && mode2 == false)
 {
  ...
  {
    HandleUltrasonicAvoidance();   //mode2
    lights();
  }
  else
  {
